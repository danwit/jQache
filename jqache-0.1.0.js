;( function ( $ ) {
    ...
    $.q = function ( selector, renew ) {
        
        var renew = ( typeof renew !== "undefined" )
            ? renew
            : false;

        if ( typeof $._jqache[selector] !== "undefined"
            && !renew ) {
    ...
    $.q.assign = function ( options ) {
        ...
        if ( typeof options.namespace === "undefined" ) {
            ...
            if ( typeof $.q[options.namespace] !== "function" ) {
                ...
                $.q[options.namespace] = function ( selector, renew ) {
                    ...
                    if ( typeof selector !== "undefined" ) {
                        ...
                        if ( typeof $._jqache[options.namespace][selector] !== "undefined"
                            && !renew ) {
                            
                            return $._jqache[options.namespace][selector];
                        } else if ( typeof $._jqache[options.namespace][selector] !== "undefined"
                            && renew ) {
